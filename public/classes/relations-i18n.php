...
/**
 * The strings RelationsEditor.jsx needs, translated in PHP and passed to the script via
 * wp_localize_script - the same pattern ph-postqueue uses, and simpler than
 * wp_set_script_translations(): no per-bundle JED JSON files, no @wordpress/i18n import in
 * the bundle at all. RelationsEditor.jsx is shared by the block editor sidebar and the
 * classic meta box, so both enqueue points call this rather than keeping two copies.
 */
class RelationsI18n {
